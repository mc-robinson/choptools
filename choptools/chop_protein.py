# !/usr/bin/env python
######################################################################################################################################
# First phase of automatic Zmatrix generator for BOSS and MCPRO.
# This program "chops" the protein down to the area of interest (ligand binding site)
#
...
#
# Usage: python chop.py -p pdb_file -r residue_name -c cutoff_size
#
...
def main():
    ...
    prepare_complex(args.zmat, args.pdb, args.resname, args.cutoff)
